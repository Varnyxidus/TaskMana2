...
export default async function ListOfMembers() {
	...
	// const filteredPermissions = (permissions as IPermission[])?.filter((permission) =>
	// 	permission.member.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
	// 	permission.role.toLowerCase().includes(searchQuery.toLowerCase()) ||
	// 	permission.status.toLowerCase().includes(searchQuery.toLowerCase())
	// );
